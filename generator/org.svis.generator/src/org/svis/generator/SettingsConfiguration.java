...
public class SettingsConfiguration {
	...
	public Color getAbapDistrictColor(String type) {
		if(type.equals("classDistrict")) {
			...
			if(config.getString("city.abap.interfaceDistrict.color").equals("")) return null;
			return getColor(config.getString("city.abap.interfaceDistrict.color", "#9499b7"));
	...
	public double getAbapAdvBuildingDefSize(String type) {
		if (type.equals("FAMIX.DataElement")) {
			...
			return config.getDouble("city.abap.adv_table_def_size", 20);	
			
		} else if (type.equals("FAMIX.TableElement")) {
			return config.getDouble("city.abap.adv_tableElement_def_size", 3);	
	...
	public double getAbapAdvBuildingScale(String type) {
		if (type.equals("FAMIX.DataElement")) {
			...
			return config.getDouble("city.abap.adv_tableElement_scale", 0.1);	
	...
	public double getAdvBuildingFloorHeight(String type) {
		if (type.equals("FAMIX.Method")) {
	...
	public double getAdvBuildingRoofHeight(String type) {
		if (type.equals("FAMIX.Method")) {
	...
	public double getAdvBuildingShapeHeight(String type) {
		if (type.equals("FAMIX.Table")) {
			return config.getDouble("city.abap.table_shape_height", 3);			
		} else {
			return 0;
		}	
	}
