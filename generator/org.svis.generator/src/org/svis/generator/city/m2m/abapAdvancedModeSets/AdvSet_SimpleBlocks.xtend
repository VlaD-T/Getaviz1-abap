		...
		«IF entity.type == "FAMIX.DataElement"»
			<Group DEF='«entity.id»'>
				<Transform translation='«entity.position.x +" "+ entity.position.y +" "+ entity.position.z»' 
						...
						«SimpleBlocks_Elements::createCylinder(entity, 2, 0, 15, getColor(entity.type))»				
				</Transform>
			</Group>
...
«««       		</Group>
       	...
       	«ELSEIF entity.parentType == "FAMIX.Interface"»			 	 
   			<Group DEF='«chimney.id»'>
   				<Transform translation='«chimney.position.x +" "+ chimney.position.y +" "+ chimney.position.z»'
   	                           scale='«getAdvBuildingScale(config.getAbapAdvBuildingScale("FAMIX.Class"))»'
   	                           rotation='0.000000 0.707107 0.707107 3.141593'>
   	                    <Shape>
   	                    	<Appearance>
   	                    		<Material diffuseColor="0.982 0.982 0.982"
   	                    			      transparency="0.0"
   	                    				  />
   	                    	</Appearance>
   	                    	<IndexedFaceSet solid="true"
